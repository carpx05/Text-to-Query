...
class TestOrchestratorAgent(unittest.TestCase):
    ...
    def test_process_query_non_ddl(
        self, MockMemory, MockQueryExecution, MockTextToSQL, MockDDL, MockDataSource
    ):
        # Setup mocks
        ...
        self.assertEqual(
            result["sql_query"], 'SELECT * FROM sales WHERE date > "2023-08-01"'
        )
        ...
        mock_query_execution.execute.assert_called_once_with(
            'SELECT * FROM sales WHERE date > "2023-08-01"', "mysql"
        )
